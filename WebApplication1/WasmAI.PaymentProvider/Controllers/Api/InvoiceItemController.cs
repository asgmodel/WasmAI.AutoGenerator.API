...
namespace WasmAI.PaymentProvider.Controllers.Api
{
    ...
    [ApiController]
    public class InvoiceItemController : BaseBPRControllerLayer<InvoiceItemRequestDso, InvoiceItemResponseDso, InvoiceItemCreateVM, InvoiceItemOutputVM, InvoiceItemUpdateVM, InvoiceItemInfoVM, InvoiceItemDeleteVM, InvoiceItemFilterVM>
    {
